...
{"features":
 ...
 "initials":
	[
		...
		{"name":"Nz","type":{"typename":"int"},"description":"number of points along z axis"},
		{"name":"x0","type":{"typename":"double"},"description":"x0 ???"},
		{"name":"z0","type":{"typename":"double"},"description":"z0 ???"},
		{"name":"v0","type":{"typename":"double"},"description":"v0 ???"},
		{"name":"DT00","type":{"typename":"double"},"description":"DT00 ???"},
		{"name":"dt0","type":{"typename":"double"},"description":"dt0 ???"},
	],
 "results":
    [
        ...
        {"name":"p1","type":"double","description":"pressure","unit":"hippos / stadium"},
        {"name":"u1","type":"double","description":"u1 velocity","unit":"sparrows / tick"},
        {"name":"u2","type":"double","description":"u1 velocity","unit":"sparrows / tick"}
    ]
}
)";
}
...
void Service::initSolver(const nlohmann::json & d)
{
	...
	solver = new breezeExampleSolver(d["params"]);
